...
@RestController
@RequestMapping("/api/panda-board-kafka")
public class PandaBoardKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PandaBoardKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PandaBoardKafkaResource(KafkaProperties kafkaProperties) {
