package com.panda.board.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.panda.board.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.panda.board.repository.UserRepository.USERS_BY_EMAIL_CACHE);
